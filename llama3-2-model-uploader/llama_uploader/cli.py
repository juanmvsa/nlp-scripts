...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="upload llama-3.2 finetuned model to hugging face")
    ...
    parser.add_argument("--skip_conversion", action="store_true", help="skip model format conversion")
